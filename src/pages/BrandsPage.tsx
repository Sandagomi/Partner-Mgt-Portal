...
const emptyForm = { partnerId: "", name: "", location: "", address: "", contact: "" };
...
export default function BrandsPage() {
  ...
  const openEdit = (b: Brand) => {
    setEditing(b);
    setForm({ partnerId: b.partnerId, name: b.name, location: b.location, address: b.address, contact: b.contact });
    setDialogOpen(true);
  };
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="bg-card rounded-lg border shadow-card overflow-hidden">
        <Table>
          ...
          <TableBody>
            {filtered.length === 0 ? (
              <TableRow><TableCell colSpan={6} className="text-center py-8 text-muted-foreground">No brands found</TableCell></TableRow>
            ) : filtered.map((b) => {
